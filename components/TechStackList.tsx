            ...
            {fullStack.map((tech, index) => {
                ...
                return (
                    <span
                        ...
                        className={`items-center gap-3 px-5 py-3 md:px-6 md:py-4 rounded-full border border-white/10 bg-white/5 text-sm md:text-base font-mono opacity-80 hover:opacity-100 hover:bg-white/10 transition-all cursor-pointer ${isHiddenOnMobile ? "hidden md:flex" : "flex"}`}
                    >
